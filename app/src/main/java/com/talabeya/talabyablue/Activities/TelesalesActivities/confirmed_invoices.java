...
public class confirmed_invoices extends AppCompatActivity {
    RecyclerView pending_rv;
    ArrayList<invoicesDomain> invoicesArrayList = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_confirmed_invoices);
        getViews();
        getData();
    }
    ...
    private void getViews() {
        pending_rv = findViewById(R.id.confirmed_invoices_rv);
    }
